...
![RAM](/assets/img/recaps/memory/dram.jpg)
...
![Cache structure](/assets/img/recaps/memory/cache.gif)
...
![Hard Disk](/assets/img/recaps/memory/hdd.png)
...
![Hard Disk](/assets/img/recaps/memory/plane-hdd.jpg)
...
![PATA and SATA cables](/assets/img/recaps/memory/pata-sata.jpg)
...
![Virtual Memory](/assets/img/recaps/memory/virtual-memory.png)
...
![Memory Hierarchy](/assets/img/recaps/memory/hierarchy.jpg)
...
Phew! That was a lot of information, but try to commit as much of it as possible to _memory_! Ha ha ha, I've been waiting all this time to drop that pun on you. We've talked a lot about hardware in the past few sections, so in the next few chapters, let's switch gears a bit and discuss the Internet!
